// src/pages/MyJournalPage.tsx
// Full-page MyJournal view — follows same layout pattern as TruthStreamPage
...
export default function MyJournalPage() {
  ...
  return (
    <>
      ...
      <style>{`
        .journal-page { scrollbar-width: none; -ms-overflow-style: none; }
