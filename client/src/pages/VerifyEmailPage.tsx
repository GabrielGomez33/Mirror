...
// Handles the verification link from email. Extracts token from URL query,
// calls backend to verify, shows success/error state.
        ...
        {status === 'error' && (
          <>
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button
                onClick={() => navigate('/dashboard')}
                className="enhanced-action-button px-5 py-2 rounded-xl text-sm font-medium text-white"
                style={{
                  background: 'linear-gradient(135deg, #ff69b4, #ff1493)',
                  transition: 'all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
                }}
