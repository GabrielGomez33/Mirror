...
export const DEV_SECTIONS: DevSectionEntry[] = [
  ...
  },
  {
    ...
    eyebrow: 'Deep dive',
    summary:
      'How personality, astrology, IQ, visual, and vocal data are captured, stored, and submitted.',
    subsections: [
      { id: 'intake-overview', title: 'Overview' },
      { id: 'intake-step-personality', title: 'Step 1 — Personality (Big-5 / MBTI)' },
      { id: 'intake-step-astrology', title: 'Step 2 — Astrology' },
      { id: 'intake-step-iq', title: 'Step 3 — IQ assessment' },
      { id: 'intake-step-visual', title: 'Step 4 — Visual (face-api)', keywords: ['tensorflow', 'face'] },
      { id: 'intake-step-vocal', title: 'Step 5 — Vocal' },
      { id: 'intake-step-submit', title: 'Step 6 — Review & submit' },
