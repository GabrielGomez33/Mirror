// src/components/three/ZenGardenSceneSakura.tsx
// Daytime/sakura zen garden (default colorway). Cherry trees, lifelike petals,
// raked sand, butterflies & fireflies. Rendered by ZenGardenScene for sakura.
...
export default function ZenGardenSceneSakura() {
  useEffect(() => {
