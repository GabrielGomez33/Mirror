// src/components/three/ZenPondSceneSakura.tsx
// Daytime/sakura zen pond (MyJournal background). Rendered by ZenPondScene for sakura.
import { useEffect } from 'react';
import * as THREE from 'three';

export default function ZenPondSceneSakura() {
  useEffect(() => {
