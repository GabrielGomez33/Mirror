// src/components/three/ZenPondScene2Sakura.tsx
// Daytime/sakura zen pond (default colorway): realistic water, cherry trees,
// lily pads, butterflies, dragonflies, fireflies. Rendered by ZenPondScene2 for sakura.
import { useEffect } from 'react';
import * as THREE from 'three';

export default function ZenPondScene2Sakura() {
  useEffect(() => {
